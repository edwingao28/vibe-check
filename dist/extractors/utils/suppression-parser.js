 ...
 */
export function parseSuppressions(source, file) {
    const facts = [];
 ...
 */
export function isLineSuppressed(suppressions, file, line, signalId) {
    return suppressions.some((s) => s.file === file &&
        (s.line === line || s.line === line - 1) &&
        (s.signals.includes(signalId) || s.signals.includes("*")));
}
//# sourceMappingURL=suppression-parser.js.map