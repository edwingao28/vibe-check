...
function analyze(ctx) {
    ...
    const sorted = [...gradientFacts].sort((a, b) => a.file < b.file ? -1 : a.file > b.file ? 1 : a.line - b.line);
    const LINE_PROXIMITY = 3;
    const instancesPerFile = new Map();
    ...
    for (let i = 1; i < sorted.length; i++) {
        ...
        if (fact.file !== currentFile || fact.line - currentLine > LINE_PROXIMITY) {
            ...
            instancesPerFile.set(fact.file, (instancesPerFile.get(fact.file) ?? 0) + 1);
        }
...
//# sourceMappingURL=gradient-overload.js.map