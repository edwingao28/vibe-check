 ...
 */
const UI_LIBRARY_PATTERNS = [/(?:^|\/)components\/ui\//];
/**
 ...
 */
const CUSTOM_COMPONENT_DIR_PATTERNS = [
    /(?:^|\/)components\/(?!ui\/)/,
    /(?:^|\/)app\//,
    /(?:^|\/)pages\//,
    /(?:^|\/)views\//,
...
function classifyFile(filePath) {
    ...
    if (!COMPONENT_EXTENSIONS.test(filePath))
        return "other";
...
//# sourceMappingURL=scaffold-bloat.js.map